...
/*function to slow appearance of link in cards to prevent their unexpected activation*/ const cards = document.getElementsByClassName("card");
...
for (const card1 of cards){
    card1.addEventListener("mouseenter", ()=>{
        if (ishovering) card1.addEventListener("mouseenter", linkToggler(card1));
    });
    card1.addEventListener("mouseleave", ()=>{
        if (!ishovering) card1.addEventListener("mouseleave", linkToggler(card1));
    });
}
/*functions to change sizes of icons, gap and <a>-tags in prefooter to fit the size of screen + change list style between column and row in footer's first section*/ const social = document.getElementById("social");
...
function toggleLg_To_1x() {
    for (const social_icon of social_icons)if (social_icon.classList.contains("fa-lg")) toggleIcons(social_icon);
}
function toggle1x_To_Lg() {
    for (const social_icon of social_icons)if (social_icon.classList.contains("fa-1x")) toggleIcons(social_icon);
}
...
function toggleSmallToMedium() {
    for (const social_button of social_buttons)if (social_button.classList.contains("small")) toggleSize(social_button);
}
function toggleMediumToSmall() {
    for (const social_button of social_buttons)if (social_button.classList.contains("medium")) toggleSize(social_button);
}
...
function changeListHorToVert() {
    if (footer_list.classList.contains("list-group-horizontal")) footer_list.classList.toggle("list-group-horizontal");
...
/*functions to rotate icons in footer's nav-toggler*/ // const nav_toggler_footer = document.getElementById('collapse_toggler_footer');
...
//         }
// });
/*functions to rotate icon in header's nav-toggler*/ // const nav_toggler_header = document.getElementById('collapse_toggler_header');
...
//         }
// });
/* general function for rotate icons in elements based on classes, so it has to be starter rotation class on the icons and others in css */ function iconSpinner(a, b, c, d) {
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dyO8b","aitAD"], "aitAD", "parcelRequire893d")
